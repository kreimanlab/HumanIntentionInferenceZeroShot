...
function dataset:__init(args)
  ...
  print('found Mengmi: ' .. #self.datamask .. ' videos')
...
function dataset:tableToOutput(dataTable, extraTable, maskTable)
   ...
   return data, extraTable, maskdata
end
...
function dataset:sample(quantity)
   ...
   return self:tableToOutput(dataTable, extraTable, maskTable)
end
