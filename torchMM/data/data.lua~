...
function data.new(n, dataset_name, opt_)
   ...
   elseif dataset_name == 'video4' then
       donkey_file = 'donkey_video4.lua'
   elseif dataset_name == 'video5' then
       donkey_file = 'donkey_video5.lua'
   elseif dataset_name == 'video7' then --for action recog; dont use normally
       donkey_file = 'donkey_video7.lua'
   elseif dataset_name == 'video8' then --for action recog; dont use normally
       donkey_file = 'donkey_video8.lua'
   elseif dataset_name == 'image' then --for action recog; dont use normally
       donkey_file = 'donkey_image.lua'
   elseif dataset_name == 'image2' then --for action recog; dont use normally
       donkey_file = 'donkey_image2.lua'
   elseif dataset_name == 'image3' then --for action recog; dont use normally
       donkey_file = 'donkey_image3.lua'
   else
