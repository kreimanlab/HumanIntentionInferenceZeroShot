...
trainbinlist = matio.load('/home/mengmi/Proj/Proj_IT/Mat/FixationPatchStore_naturaldesign.mat')
...
print('There are trials: ' .. TotalTrials )
targetsize = 28
stimulisize = 224
...
for i=1,TotalTrials do
   ...
   imagename_stimuli = '/media/mengmi/TOSHIBABlue1/Proj_VS/Datasets/NaturalDataset/filtered/gray' .. string.format( "%03d", stimuliind ) ..  '.jpg'
   imagename_target = '/media/mengmi/TOSHIBA2/Proj_IT/Datasets/FixationPatchNaturalDesign_224/subj_' .. subjind .. '_stimuli_' .. stimuliind .. '_patch_' .. patchind .. '.jpg'
   ...
   savefile = '/media/mengmi/TOSHIBA2/Proj_IT/results/PatchNaturalDesignAttentionMap/subj_' .. subjind .. '_stimuli_' .. stimuliind .. '_patch_' .. patchind .. '_layer_' .. MyLayer .. '.mat'
